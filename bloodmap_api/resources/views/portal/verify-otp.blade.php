...
<head>
    ...
    <title>Verify Code — SmartBlood PH</title>
...
<body class="login-body">
    ...
    <div class="login-card">
        ...
        <p class="login-subtitle">Enter the verification code sent to your email to complete sign-in.</p>
        ...
        <form method="POST" action="{{ route('portal.otp.verify.submit') }}" class="login-form">
            @csrf
            <div class="form-group floating-label">
                <input type="text" id="code" name="code" value="{{ old('code') }}" required autofocus placeholder=" ">
